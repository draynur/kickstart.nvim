...
--]]
--
-- Probably shouldn't be doing this here, but whatever
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>srg', builtin.live_grep, { desc = '[S]earch by [G]rep' })
            ...
            plugins = {
              {
                ...
                location = '/home/jack/.local/share/pnpm/nodejs/20.17.0/lib',
                languages = { 'vue' },
              },
            },
          },
